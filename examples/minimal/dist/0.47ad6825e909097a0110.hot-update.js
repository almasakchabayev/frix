...
/***/ function(module, exports, __webpack_require__) {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', { onChange: function onChange(e) {
	              return _this2.props.updateName$.next(e.target.value);
	            } })
	        )
	      );
	    } // a little worker
	...
	Hello.propTypes = {
	  ...
	  updateName$: _react2.default.PropTypes.any
	};
	exports.default = (0, _src.createContainer)(Hello, function (intents, getModel) {
	  // just like a manager
	  var fragments = {
	    hello: null,
	    name: null
	  ...
	  updateName$.subscribe(function (name) {
	    return getModel().update({ name: name });
	  });
...
//# sourceMappingURL=0.47ad6825e909097a0110.hot-update.js.map