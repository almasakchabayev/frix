	  ...
	  var Container = function (_React$Component) {
	    ...
	    function Container(props, context) {
	      ...
	      _this.subscription = _this.model.$.flatMap(function (_) {
	        ...
	        return console.log((0, _utils.toPaths)(fragments)) || _Observable.Observable.fromPromise((_this$model = _this.model).get.apply(_this$model, _toConsumableArray((0, _utils.toPaths)(fragments))));
...
//# sourceMappingURL=0.c1390e7e909848544827.hot-update.js.map